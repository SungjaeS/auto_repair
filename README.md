...
- JS를 통해 AI API 연동시 기본 자료를 주셨으나 chatgpt를 이용해서 기본틀을 만들다보니 서비스를 연결해주는데 에러가 나고 더 헤메게 되었습니다.
  다행이 기본 파일과 gpt가 만들어준 파일을 비교해가면서 부분을 수정해주니 연동되었습니다.

## 11. 개발하며 느낀점
- 과제를 보고 막상 이걸 내가 어떻게하지 라고 생각 했었는데 막상 해보니 흥미와 재미를 느꼇고 그저 수업만 듣고 복습하는것보다 스스로 공부하고 앞으로 공부해나가야 하는방향에 도움이 되는
 유익한 시간이었던거 같습니다.
