...
## 11. 개발하며 느낀점
- 이제 3달째 교육중 머리에 입력이 안되고 외계어나 진흙탕으로 보이다가 가끔 입력되다가도 흩어져버리는 상황 그런데 항상은 아니어도 간혹 재미와 흥미를 느낌니다. 

- 막상 이걸 내가 어떻게해? 라고 생각 했었는데 발등에 불이 떨어지자 Chatgpt와 잔머리를 이용 다행이? '죽'이라도 만든거 같습니다.

- 앞으로 배워야 할게 더 많지만 지금까지 배운것을 혼자있을때 습관화하여 버릇처럼 공부 해야겠습니다.
